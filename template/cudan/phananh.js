...
function confirmSubmission(event) {
    ...
    var confirmation = confirm("Bạn có chắc chắn muốn gửi không?");
    ...
    if (confirmation) {
        ...
        var newRecord = {
            ...
            "idCudan": "CDS201", // Bạn có thể thay đổi giá trị này theo logic của mình
            "idHome": "S201", // Bạn có thể thay đổi giá trị này theo logic của mình
            "loaiPA": loaiPA,
            "trangThai": "Chưa duyệt", // Bạn có thể thay đổi giá trị này theo logic của mình
            "noiDung": noiDung,
            "image": imageName,
            "thoiGian": new Date().toLocaleDateString() // Sử dụng thời gian hiện tại
        };
        ...
        // Thay thế bằng hành động thực tế cần thực hiện khi người dùng xác nhận
        // Ví dụ: Hiển thị thông báo, làm sạch form, v.v.
        alert("Dữ liệu đã được gửi và lưu thành công!");
        document.getElementById("myForm").reset(); // Làm sạch form
        $('#newPA').modal('hide');
        location.reload();
