                            ...
                            <div class="col-xl-12">
                                <div class="card" style="border-radius: 15px;">
                                    ...
                                    <div class="icon-chat" style="display:flex;padding-top:50px;padding-left:100px; font-family: 'Inter';font-style: normal;font-weight: 600;font-size: 14px; line-height: 21px;letter-spacing: 0.1px;color: #000000;">
                                            ...
                                            <a href=""><div style="padding-top:7px;padding-left:10px;font-family: 'Inter';font-style: normal;font-weight: 700;font-size: 12px;line-height: 26px;text-decoration-line: underline;color: #164863;">Xem chi tiết >></div></a>
                                     </div>
                                     <a href=""><div class="require" style="position:relative; margin-left:100px;margin-bottom:20px; margin-top:10px; background-color: #E8EDF0; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 15px; width:1000px; height:120px; color: #090909;">
                                        ...
                                        <a href=""><div class="detail-require" style="position:absolute;top:80px;right:50px;font-family: 'Inter';font-style: normal;font-weight: 600;font-size: 14px;line-height: 21px;letter-spacing: 0.1px;color: #164863;">Xem thêm</div></a>
                                    </div></a>
                                    <a href=""><div class="require" style="position:relative; margin-left:100px;margin-bottom:20px; margin-top:10px; background-color: #E8EDF0; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 15px; width:1000px; height:120px; color: #090909;">
