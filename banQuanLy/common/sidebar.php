...
<div class="containeri" style="display:flex; width:100%; ">
    <div class="menu" style="position: fixed;background-color:#FFFFFF;margin-top:100px;margin-left:30px; width:300px;border-radius: 14px;height:px;">
        ...
        <div class="menu-item <?php echo (in_array($current_file_name, ['xemThongKe.php', 'thongKeTaiChinh.php', 'thongKeCuDan.php', 'thongKeDichVu.php'])) ? 'active' : ''; ?>">
            <a href="/banQuanLy/xemThongKe/xemThongKe.php" class="nav-link ">
                <span class="pcoded-micon"><i class="fas fa-chart-bar" style="color: #000000;width:30px;height:30px;"></i></span>
                <span class="menu-options">Xem thống kê</span>
            </a>
        </div>
