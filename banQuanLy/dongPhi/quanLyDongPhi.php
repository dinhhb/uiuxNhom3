...
<head>
    <title>BQL-Quản lý đóng phí</title>
    <meta charset="utf-8">
...
<body>
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="mt-3 justify-content-between">
                                                <form class="d-flex justify-content-between" style="display: flex; align-items: center; justify-content: start; gap: 20px;">
                                                    ...
                                                    <button id="addServiceButton" class="btn btn-primary btn-group">Thêm dịch vụ
                                                    </button>
                                                </form>
                                            </div>
                                            <div class="toolbar-container d-flex justify-content-between" style="display: flex; align-items: center; justify-content: start; gap: 20px;">
                                                <div class="btn-group dropdown custom-dropdown" id="choice">
                                                    <button class="btn btn-third dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="choiceButton" value="all">Chọn tình trạng
                                                    </button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" value="all">Tất cả</a>
                                                        <a class="dropdown-item" value="notPay">Chưa đóng</a>
                                                        <a class="dropdown-item" value="Pay">Đã đóng</a>
                                                    </div>
                                                </div>
    ...
    <script src="Js/quanLyDongPhi.js"></script>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="feeName">Tên dịch vụ</label>
                        <input type="text" class="form-control" id="feeName" placeholder="Nhập tên dịch vụ">
                    </div>

                    <!-- Fee Type Dropdown -->
                    <div class="form-group">
                        <label for="feeType">Loại dịch vụ</label>
                        <select class="form-control" id="feeType">
                            <!-- <option selected>Chọn loại dịch vụ</option> -->
                            <option selected value="type1">Dịch Vụ Cơ Bản</option>
                            <option value="type2">Dịch Vụ An Ninh và Bảo Vệ</option>
                            <option value="type3">Dịch Vụ Gửi Xe và Đỗ Xe</option>
                            <option value="type4">Dịch Vụ Bảo Hiểm và An Toàn</option>
                            <option value="type5">Dịch Vụ Bảo Dưỡng và Sửa Chữa</option>
                            <option value="type6">Dịch Vụ Giải Trí và Thể Thao</option>
                ...
                <div class="modal-footer">
                    ...
                    <button id="addServiceButtonPopup" type="button" class="btn btn-primary">Thêm dịch vụ</button>
                </div>
            </div>
        </div>
    </div>
