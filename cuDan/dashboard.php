                                    ...
                                    <div class="card" style="border-radius: 15px;">
                                        ...
                                        <div style="display:flex;position:relative;">
                                            <div class="img-dashboard" style="padding-top:30px;padding-left:375px;">
                                                <img style="width: 387px;height: 381px;filter: drop-shadow(0px 4px 4px rgba(22, 72, 99, 0.25));border-radius: 30px;" src="../assets/images/chung-cu-mini.jpg">
                                            </div>
